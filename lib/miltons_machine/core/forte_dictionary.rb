...
module MiltonsMachine
  module Core
    ...
    #
    #    major_scale = MiltonsMachine::Core::ForteDictionary.instance.get_set("7-35")
    #    puts major_scale
    #
    #    # would print out [0, 1, 3, 5, 6, 8, 11]
    #
    #    interval_vector = MiltonsMachine::Core::ForteDictionary.instance.get_vector("7-35")
    #    puts interval_vector
    #
    #    # would print out [7, 2, 5, 4, 3, 6, 1]
    #
    #    description = MiltonsMachine::Core::ForteDictionary.instance.get_description("7-35")
    #    puts description
    #
    #    # would print out "Major Diatonic Heptachord/Dominant-13th, Locrian (1221222), Phrygian (1222122),
    #       Major inverse"
    #
    ...
    class ForteDictionary
      ...
      #        Even though an interval vector isn't quite a ForteSet, we treat it as such for translation purposes.
      #
      ...
      def load_dictionary
        ...
        file.each_line("\n") do |row|
          ...
          set_name        = columns[0]
          forte_set       = MiltonsMachine::Core::ForteSet.new( columns[1].split('') ).convert_set_from_alpha!
          interval_vector = MiltonsMachine::Core::ForteSet.new( columns[2].split('') ).convert_set_from_alpha!
