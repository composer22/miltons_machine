...
Milton's Machine's goal is to provide a "practical" application of set theory tools for musical composition, with some
support for analysis - as defined in the various contexts of 12 tone theory and its offshoots
...
* ForteSet - an extention to the Ruby Array class that adds additional operations via modulo 12.
...
Currently, we are still in pre-release mode, but eventually:
