...
* ForteSets - a class that provides a dictionary of pitch class sets as cataloged by Forte, including a set of operations to act on them via modulo 12.
...
example: <b>"row row row your boat"</b>
    ...
    0.upto(11) do |i|
      ...
      analysis_engine.add_forte_set("3-11i", i)            # TnI     <== or optionally use Forte Set names like here
    end
