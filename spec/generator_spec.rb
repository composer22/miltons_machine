...
describe MiltonsMachine::Tools::Generator do
  ...
  context "when performing permutation operations" do
    ...
    it "should calculate the harmonic series correctly" do
      input_frequency = 440
      solution_set = [440, 880, 1320, 1760, 2200, 2640, 3080, 3520, 3960, 4400, 4840, 5280, 5720, 6160, 6600, 7040,
                      ...
                      19360, 19800]
      final_results =  subject.calculate_harmonics( input_frequency )
  ...
  context "when performing translation operations" do
    ...
    it "should calculate equal temperament frequency correctly" do
      ...
      -16.upto(16) do |n|
        final_result << subject.calculate_equal_frequency(n).round(2)
      end
